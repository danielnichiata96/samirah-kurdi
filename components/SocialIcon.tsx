...
type Network = 'instagram' | 'tiktok' | 'pinterest';
...
export function SocialLink({ href, network, className, label }: { href?: string; network: Network; className?: string; label?: string }) {
  ...
  return (
    <a
      ...
      className={cn(
        'inline-flex h-9 w-9 items-center justify-center rounded-full border border-zinc-300 text-zinc-700 hover:bg-zinc-100 transition shadow-[0_2px_0_0_rgba(0,0,0,0.06)]',
