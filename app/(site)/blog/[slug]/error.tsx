    ...
    <Section>
      <Container>
        <div className="mx-auto max-w-2xl text-center py-10">
          <p className="text-sm font-semibold tracking-wide text-rose-600">Falha ao carregar artigo</p>
          <h1 className="mt-2 text-3xl md:text-4xl font-bold">Algo deu errado</h1>
          <p className="mt-3 text-zinc-600">Tente novamente em instantes. Se o problema persistir, volte para o blog.</p>
          <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
            ...
            <Link href="/blog" className="text-sm text-zinc-700 hover:underline">Voltar ao Blog</Link>
          </div>
        </div>
      </Container>
    </Section>
