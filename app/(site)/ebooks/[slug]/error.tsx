...
export default function EbookError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <Section>
      <Container>
        <div className="mx-auto max-w-2xl text-center py-10">
          <p className="text-sm font-semibold tracking-wide text-rose-600">Falha ao carregar e-book</p>
          <h1 className="mt-2 text-3xl md:text-4xl font-bold">Algo deu errado</h1>
          <p className="mt-3 text-zinc-600">Tente novamente em instantes. Se o problema persistir, volte para a lista de e-books.</p>
          <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
            ...
            <Link href="/ebooks" className="text-sm text-zinc-700 hover:underline">Ver E-books</Link>
          </div>
        </div>
      </Container>
    </Section>
